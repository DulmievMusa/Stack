...
main.exe : main.o stack_operations.o asserts.o stack_security.o byte_code_read.o
...
main.o: macros.h constants.h data_types.h asserts.h stack_security.h byte_code_read.h
